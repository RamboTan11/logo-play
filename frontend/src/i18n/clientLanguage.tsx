...
const english: Record<string, string> = {
  ...
  '品牌域名': 'Brand domain',
  '从品牌域名开始': 'Start with your brand domain',
  ...
  '将字母与图形自然交织，形成紧凑且有辨识度的标记。': 'Naturally interweaves letters and forms into a compact, distinctive mark.',
  '几何组合': 'Geometric composition',
  '以清晰结构和利落比例组织图形，呈现稳定的数字品牌感。': 'Organizes forms with clear structure and crisp proportions for a stable digital brand feel.',
  '徽章式': 'Emblem style',
  '用凝练的轮廓与中心符号建立强识别的品牌徽记。': 'Uses a concise outline and central symbol to establish a recognizable emblem.',
  '娱乐图标': 'Entertainment icon',
  '以轻松而有记忆点的图形语言，为娱乐品牌保留鲜明动势。': 'Uses playful, memorable forms to retain a clear sense of motion for entertainment brands.',
  '上一张样图': 'Previous sample image',
  '下一张样图': 'Next sample image',
  '重叠融合样图 1': 'Overlapping fusion sample 1',
  '重叠融合样图 2': 'Overlapping fusion sample 2',
  '几何组合样图 1': 'Geometric composition sample 1',
  '几何组合样图 2': 'Geometric composition sample 2',
  '几何组合样图 3': 'Geometric composition sample 3',
  '徽章式样图 1': 'Emblem style sample 1',
  '娱乐图标样图 1': 'Entertainment icon sample 1',
  '娱乐图标样图 2': 'Entertainment icon sample 2',
  ...
  '开小差了，请重试': 'A small detour. Please retry.',
  ...
  '将为您生成创意初稿': 'We will generate your initial concepts',
  ...
  '交付回响': 'Delivery notes',
  '期待你点亮的每颗🌟': 'Every star is yours to light',
  ...
  '本次服务是否满意？': 'Are you satisfied with this service?',
  '本次服务是否满意': 'Are you satisfied with this service',
  '感谢您的评价': 'Thank you for your rating',
